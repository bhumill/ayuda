							...
							<aside className="app-sidebar doc-sidebar my-dash">
								<div className="app-sidebar__user clearfix">
									<ul className="side-menu">
										...
										<li>
											<a className="side-menu__item" href="myads.html"><i className="icon icon-diamond"></i><span className="side-menu__label ml-2">Articles</span></a>
										</li>
										<li className="slide">
											...
											<ul className="slide-menu">
												<li><a className="slide-item" href="myfavorite.html"><i className="fa fa-angle-right mr-2"></i>Symptoms</a></li>
										...
										<li className="slide">
											...
											<ul className="slide-menu">
												<li><a className="slide-item" href="manged.html"><i className="fa fa-angle-right mr-2"></i>View Medication</a></li>
												<li><a className="slide-item" href="#"><i className="fa fa-angle-right mr-2"></i>Add Medication</a></li>
												
											</ul>
										</li>
										<li>
											<a className="side-menu__item" href="payments.html"><i className="icon icon-credit-card"></i><span className="side-menu__label ml-2">Appointments</span></a>
                                            <ul className="slide-menu">
												<li><a className="slide-item" href="manged.html"><i className="fa fa-angle-right mr-2"></i>Past Appointments</a></li>
												<li><a className="slide-item" href="#"><i className="fa fa-angle-right mr-2"></i>Upcoming Appointments</a></li>
												
											</ul>
										</li>
										<li>
											<a className="side-menu__item" href="orders.html"><i className="icon icon-basket"></i><span className="side-menu__label ml-2">Payment History</span></a>
										</li>
										<li>
											<a className="side-menu__item" href="tips.html"><i className="icon icon-game-controller"></i><span className="side-menu__label ml-2">Notifications</span></a>
										</li>
										<li>
											<a className="side-menu__item" href="settings.html"><i className="icon icon-settings"></i><span className="side-menu__label ml-2">Support </span></a>
										</li>
										<li>
											<a className="side-menu__item" href="login.html"><i className="icon icon-power"></i><span className="side-menu__label ml-2">User Activity</span></a>
										</li>
									</ul>
								</div>
							</aside>

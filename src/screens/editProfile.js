...
import Left from '../components/leftDashboard.js'
...
<Header></Header>
		...
		{/* <!--Breadcrumb--> */}
		<section>
			<div className="bannerimg cover-image bg-background3" style = {{color : 'blue'}}>
						...
						<div className="card mb-0">
							...
							<div className="card-body">
								<div className="row">
									...
									<div className="ol-sm-6 col-md-6">
										<div className="form-group">
									...
									<div className="col-sm-6 col-md-4">
										<div className="form-group">
											...
											<input type="text" className="form-control" placeholder="Emergency Contact Email"/>
										</div>
									</div>
									<div className="col-sm-6 col-md-4">
										<div className="form-group">
											<label className="form-label">Mobile Number</label>
											<input type="text" className="form-control" placeholder="Emergency Contact umber"/>
										</div>
									</div>
									<div className="col-md-12">
                                    <div className="form-group">
